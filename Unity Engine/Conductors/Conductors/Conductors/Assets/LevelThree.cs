...
public class LevelThree : MonoBehaviour
{
    ...
    private float movementAmount = 2.3f; //the amount of pixels a cube will move on the x,y axis.
    ...
    void initializeBoard(){
        ...
        board[0,2] = new Tile(false,true,true,false,false,false,false);
        board[0,3] = new Tile(false,false,true,true,false,false,false);
        board[0,4] = new Tile(false,false,true,false,false,false,false);
        board[1,0] = new Tile(true,true,true,false,false,false,false);
        board[1,1] = new Tile(true,false,true,true,false,false,false);
        board[1,2] = new Tile(true,true,true,false,true,false,false);
        board[1,3] = new Tile(true,false,true,true,false,false,false);
        board[1,4] = new Tile(true,false,true,false,false,false,false);
        board[2,0] = new Tile(true,false,true,false,false,false,false);
        board[2,1] = new Tile(true,true,true,false,false,false,false);
        board[2,2] = new Tile(true,false,true,true,true,false,false);
        board[2,3] = new Tile(true,true,true,false,false,false,false);
        board[2,4] = new Tile(true,false,true,true,false,false,false);
        board[3,0] = new Tile(true,false,false,false,false,false,false);
        board[3,1] = new Tile(true,true,false,false,false,false,false);
        board[3,2] = new Tile(true,false,false,true,false,false,false);
        board[3,3] = new Tile(true,true,false,false,false,false,false);
        board[3,4] = new Tile(true,false,false,true,false,false,true);
    }//end initializeBoard() 
    ...
    void isLevelComplete(){
        ...
        if((board[1,2].getIsCubyOn() || board[1,2].getIsSquaresomeOn()) && (board[2,2].getIsCubyOn() || board[2,2].getIsSquaresomeOn()) ){
